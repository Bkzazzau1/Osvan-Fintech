// lib/screen/security/set_pin_view.dart
// Dashboard-Luxury Set PIN (100% consistent style)
// ✅ Keeps SecurityApi.setPin(a) exactly
...
class _SetPinViewState extends State<SetPinView> {
  ...
  Future<void> _save() async {
    ...
    if (a != b) {
      _toastErr("Mismatch", "PINs do not match");
      return;
    }

    if (!_isStrongEnough(a)) {
    ...
    try {
      ...
      final msg = _extractErr(e) ?? "Failed to set PIN. Please try again.";
      _toastErr("Error", msg);
    } catch (_) {
      _toastErr("Error", "Failed to set PIN. Please try again.");
    } finally {
                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: ListView(
                      ...
                      SectionCard(
                        title: "Security",
                        subtitle: "Create your 4-digit transaction PIN",
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            Text(
                              "This PIN will be required for sensitive actions like transfers.",
                            ...
                            _PinStrengthBar(pin: _pin.text.trim()),
...
// Strength bar (same as ChangePinView)
